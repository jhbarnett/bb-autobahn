...
Autobahn is a compact, policy-driven board for [bb](https://github.com/get-bb/bb). Each visible card is a stable controller thread; fresh hidden agents perform bounded planning and verification passes in isolated worktrees.
